...
class LocalDatabase {
    ...
    async initialize() {
        try {
            ...
            logger_1.logger.info('Local database initialized successfully');
        }
        catch (error) {
            logger_1.logger.error('Failed to initialize local database:', error);
            throw error;
        }
    }
    async createTables() {
    ...
    async insertSensorData(data) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to insert sensor data:', error);
            throw error;
        }
    }
    async getSensorData(sensorId, limit = 100) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to get sensor data:', error);
            throw error;
        }
    }
    async getUnsyncedSensorData(limit = 100) {
        return this.knex('sensor_data')
            .whereNull('synced_at')
            .orderBy('created_at', 'desc')
            .limit(limit);
    }
    async getUnsyncedAlerts(limit = 100) {
        return this.knex('alerts')
            .whereNull('synced_at')
            .orderBy('created_at', 'desc')
            .limit(limit);
    }
    async getUnsyncedFarms(limit = 100) {
        return this.knex('farms')
            .whereNull('synced_at')
            .orderBy('updated_at', 'desc')
            .limit(limit);
    }
    async markSensorDataSynced(ids) {
        await this.knex('sensor_data')
            .whereIn('id', ids)
            .update({ synced_at: new Date() });
    }
    async markAlertsSynced(ids) {
        await this.knex('alerts')
            .whereIn('id', ids)
            .update({ synced_at: new Date() });
    }
    async markFarmsSynced(ids) {
    ...
    async insertAlert(alert) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to insert alert:', error);
            throw error;
        }
    }
    ...
    async getFarmsModifiedSince(since) {
        if (!this.knex)
            throw new Error('Database not initialized');
        try {
            ...
            logger_1.logger.error('Failed to get farms modified since:', error);
            throw error;
        }
    }
    async getFieldsModifiedSince(since) {
        if (!this.knex)
            throw new Error('Database not initialized');
        try {
            ...
            logger_1.logger.error('Failed to get fields modified since:', error);
            throw error;
        }
    }
    async getSensorDataSince(since) {
        if (!this.knex)
            throw new Error('Database not initialized');
        try {
            ...
            logger_1.logger.error('Failed to get sensor data since:', error);
            throw error;
        }
    }
    async getFieldById(id) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to get field by id:', error);
            throw error;
        }
    }
    async updateField(id, field) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to update field:', error);
            throw error;
        }
    }
    async insertField(field) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to insert field:', error);
            throw error;
        }
    }
    async insertObservation(observation) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to insert observation:', error);
            throw error;
        }
    }
    async insertPhoto(photo) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to insert photo:', error);
            throw error;
        }
    }
    async insertTask(task) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to insert task:', error);
            throw error;
        }
    }
    async close() {
    ...
    async insertFarm(farm) {
        try {
            ...
            logger_1.logger.error('Error inserting farm:', error);
            throw error;
        }
    }
